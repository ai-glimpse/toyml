...
class TestAGNES:
    ...
    def test_fit_predict(self, sample_dataset):
    ...
    def test_linkage_methods(self, sample_dataset):
    ...
    def test_distance_matrix(self, sample_dataset, n_cluster):
    ...
    def test_n_cluster_validation(self):
    ...
    def test_dataset_rows_validation(self):
    ...
    def test_different_n_clusters(self, sample_dataset, n_cluster):
        agnes = AGNES(n_cluster=n_cluster).fit(sample_dataset)
        assert len(set(agnes.labels_)) == n_cluster

    def test_plot_dendrogram(self, sample_dataset, tmp_path):
    ...
    def test_plot_dendrogram_invalid_n_cluster(self, sample_dataset):
    ...
    def test_linkage_matrix(self, sample_dataset):
        agnes = AGNES(n_cluster=1).fit(sample_dataset)
    ...
    def test_cluster_indices(self, sample_dataset):
        agnes = AGNES(n_cluster=2).fit(sample_dataset)
        all_indices = set()
